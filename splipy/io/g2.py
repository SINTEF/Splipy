...
from typing import TYPE_CHECKING, ClassVar, Literal, Optional, Sequence, TextIO, Union
...
from splipy.utils import rotate_local_x_axis
...
class G2(MasterIO):
    ...
    def __enter__(self) -> Self:
        self.fstream = self.filename.open(self.mode).__enter__()
        return self
