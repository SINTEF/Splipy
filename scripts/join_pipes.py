...
c_face_1 = LoftCurves([c_circ_in_1,c_circ_out_1])
c_face_2 = LoftCurves([c_circ_in_2,c_circ_out_2])
c_face_3 = LoftCurves([c_circ_in_3,c_circ_out_3])

# End faces
e_face_1 = LoftCurves([e_circ_in_1,e_circ_out_1])
e_face_2 = LoftCurves([e_circ_in_2,e_circ_out_2])
e_face_3 = LoftCurves([e_circ_in_3,e_circ_out_3])
e_face_4 = LoftCurves([e_circ_in_4,e_circ_out_4])
e_face_5 = LoftCurves([e_circ_in_5,e_circ_out_5])
e_face_6 = LoftCurves([e_circ_in_6,e_circ_out_6])

# Pipe solids
pipe_1 = LoftSurfaces([c_face_1,e_face_1])
pipe_2 = LoftSurfaces([c_face_2,e_face_2])
pipe_3 = LoftSurfaces([c_face_1,e_face_3])
pipe_4 = LoftSurfaces([c_face_3,e_face_4])
pipe_5 = LoftSurfaces([c_face_3,e_face_5])
pipe_6 = LoftSurfaces([c_face_2,e_face_6])
